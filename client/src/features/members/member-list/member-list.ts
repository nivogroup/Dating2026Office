...
export class MemberList implements OnInit {
  ...
  // For the local storage of memberParams, persisting the filter selection
  ...
  get displayMessage(): string {
    ...
    if(this.updatedParams.minAge !== defaultParams.maxAge || this.updatedParams.maxAge !== defaultParams.maxAge) {
